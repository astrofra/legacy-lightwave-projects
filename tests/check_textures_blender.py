...
def worker(args):
    ...
    for format_name in ("gltf", "obj"):
        ...
        with tempfile.TemporaryDirectory(prefix="lw-textures-portable-") as temp:
            ...
            for filename in ("oj_tv_mesh_t.lwo", "sol.lwo"):
                ...
                for name in ("screen","orange_skin","vert") if filename.startswith("oj_") else ("sol",):
                ...
                if args.preview and format_name == "gltf" and filename == "oj_tv_mesh_t.lwo":
                    ...
                    bpy.ops.object.camera_add(location=center+Vector((2.8,-1.2,.7)))
                    ...
                    light = bpy.context.object; light.data.energy=400; light.data.shape='DISK'; light.data.size=4
