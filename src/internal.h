...
int lw_prepare_clip_scene(const char *,LWPackage *,LWScene *,LWError *);
int lw_clip_consensus(LWObject *,LWError *);
const LWClipBinding *lw_clip_binding(const LWObject *,uint32_t,uint32_t);
void lw_json_clip_bindings(FILE *,const LWObject *);
int lw_composite_clip(const char *,const char *,const LWObject *,size_t,const LWTexture *,const LWImageReference *,LWClipBinding *,LWError *);
